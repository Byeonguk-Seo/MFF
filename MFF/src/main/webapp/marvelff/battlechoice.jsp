...
String boss = request.getParameter("hero");
...
<!-- 내용 -->
<table id="notice">
<tr><td colspan="4">배들할 히어로 선택</td></tr>
<tr><td colspan="2">이름</td><td>레벨</td><td>경험치</td><td></td></tr>

<%
for(int i = 0; i < myHeroList.size(); i++){
	   MyheroDTO myHeroDTO = (MyheroDTO)myHeroList.get(i);
%>
<tr><td colspan="2"><%=myHeroDTO.getHero()%></td><td><%=myHeroDTO.getHlevel()%></td><td><%=myHeroDTO.getExp()%></td><td><input type="button" name="battle" value="배틀" onclick="location.href='battlePro.jsp?hero=<%=myHeroDTO.getHero()%>&boss=<%=boss%>'"></td></tr>
<%
	}
%>
</table>
